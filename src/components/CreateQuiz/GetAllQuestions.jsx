...
// const GetAllQuestions = ({ setUrl, changePopup, type }) => {
//     const navigate = useNavigate()
//     const {quizeData, setQuizeData} = useContext(quizeContext);

//     //declaring initiall states with some dummy data
//     const initialQues = quizeData.quizeType == 'QnA' ? quizeData.QnAQuestions : quizeData.pollQuestions;

//     // const initialEditQues = [...dummyQ]
//     // const initialCreateQues = [{ ...dummyQ[0] }]
...
//                 setQuizeData([...questions, { ...quizeInfo.QnAQuestions[0] }])
//             } else {
//                 setQuestions([...questions, { ...quizeInfo.pollQuestions[0] }])
//             }

//             // if (quizeData.type == 'QnA') {
//             //     setQuizeData({...quizeData, QnAQuestions: [...quizeData.QnAQuestions, { ...quizeInfo.QnAQuestions[0] }]})
//             // } else {
//             //     setQuizeData({...quizeData, pollQuestions: [...quizeData.pollQuestions, { ...quizeInfo.pollQuestions[0] }]})
//             // }
//         }
//     }
